...
var source = (() => {
  ...
  var GocTruyenTranhInterceptor = class extends import_types.PaperbackInterceptor {
    async interceptRequest(request) {
      request.headers = {
        ...request.headers ?? {},
        ...{
  ...
  var GocTruyenTranhExtension = class {
    ...
    globalRateLimiter = new import_types2.BasicRateLimiter("ratelimiter", {
      numberOfRequests: 5,
      bufferInterval: 1,
      ignoreImages: true
    });
    ...
    cookieStorageInterceptor = new import_types2.CookieStorageInterceptor({
